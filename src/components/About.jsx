...
const About = () => {
  return (
    <>
      ...
      >
        As a tech professional with over 4+ years of experience ranging from
        having being a <span>support application analyst</span> to being a
        ...
        designers to software engineers to managers.
      </motion.p>
