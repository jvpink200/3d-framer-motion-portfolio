  ...
  return (
    <>
      ...
      >
        ...
        skill set by having strong debugging skills to even photoshop and figma.
        These technical skills allow me to create beautiful, dynamic, and
        responsive websites while writing clean code that is reusable. I thrive
        in collaborative environments with cross-functional teams from designers
        to software engineers to managers.
      </motion.p>
